...
object CompareGreedyTilePackingl1 extends App {
  ...
  def runAllAlgorithms(instance: Instance, ratio: Double): Vector[String] = {
    ...
    if (outputGreedy1.objectiveValue/outputTilePacking1.objectiveValue > ratio) {
      ...
      subplot.plot(
        ...
        Layout(
          title = "Greedy / Tilepacking greater than " + ratio,
          showlegend = false,
          height = 800,
          width = 800,
          xaxis = Axis(
      ...
      Vector(
        ...
        (outputGreedy1.objectiveValue/outputTilePacking1.objectiveValue).toString,
  ...
  val vectorNumberOfInstances: Vector[Integer] = Vector(100000,50000,5000,1000,50,0)
  val ratio: Double = 1.1
  ...
  def writeSpreadsheet(data:Vector[Vector[String]]): Unit = {
    ...
    val filename = System.getProperty("user.dir") + "/outputFiles/test/"+"CompareGreedyTile.xlsx"
